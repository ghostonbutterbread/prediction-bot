        ...
        *,
        ...
        for source_name in source_names:
            ...
            source = {
                ...
                "forecast_availability": detail.get("forecast_availability"),
                "scoreable_forecast": detail.get("scoreable_forecast"),
                "availability_reason": detail.get("availability_reason"),
                "market_target_date": detail.get("market_target_date"),
                "source_target_date": detail.get("source_target_date"),
                "target_mapping": detail.get("target_mapping") if isinstance(detail.get("target_mapping"), dict) else None,
